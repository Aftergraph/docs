  ...
  integrations: [
    starlight({
      ...
      head: [
        ...
        { tag: 'meta', attrs: { property: 'og:image', content: 'https://docs.aftergraph.org/og-docs.png' } },
        { tag: 'meta', attrs: { property: 'og:image:width', content: '1200' } },
        { tag: 'meta', attrs: { property: 'og:image:height', content: '630' } },
        { tag: 'meta', attrs: { property: 'og:image:alt', content: 'Aftergraph Docs — Specify the mission. Verify the system.' } },
        { tag: 'meta', attrs: { name: 'twitter:card', content: 'summary_large_image' } },
        { tag: 'meta', attrs: { name: 'twitter:image', content: 'https://docs.aftergraph.org/og-docs.png' } },

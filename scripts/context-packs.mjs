...
const nextReading = {
  ...
  'developers/api-reference': ['developers/schemas/', 'developers/mcp-boundary/'],
  'developers/schemas': ['developers/api-reference/', 'developers/mcp-boundary/'],
  'developers/mcp-boundary': ['developers/api-reference/', 'developers/agent-guide/'],
  'developers/agent-guide': ['developers/mcp-boundary/', 'developers/quickstart/'],
  'developers': ['developers/quickstart/', 'developers/api-reference/'],
  'standards/bindings': ['standards/contracts/', 'standards/conformance/'],
  'standards/conformance': ['evidence/claim-graph/', 'standards/bindings/'],
  'research/benchmarks': ['evidence/claim-graph/', 'research/'],
  'examples': ['developers/tutorials/', 'developers/how-to/'],
  'company/versions': ['company/changelog/', 'status/'],
  'start': ['developers/quickstart/', 'concepts/'],
  'concepts': ['platform/golden-mission/', 'products/'],
  'products': ['platform/system-map/', 'catalog/'],

---
title: "Sentinel — CLI v0 Features"
...
## F-03 — 6-rule static check pack

Runs `sentinel-rules@1.0.0` (§3 of the design doc): unauth endpoints, CI-config secrets, migration rollback, concurrent indexing, N+1, dataloader (cut from 10 by precision audit; secrets delegated to gitleaks, race/idempotency deferred to v1). Each check reports pass/fail with file:line evidence; style-severity observations are shown but never block.
...
> Source: Aftergraph/sentinel@1a8692b93cb3eb664e51bca7b43f5366244b30fa docs/cli-v0-features.md.md — verbatim, pinned, no reinterpretation.

<Provenance page="sentinel/cli-v0-features" />

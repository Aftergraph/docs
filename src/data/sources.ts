...
export const SOURCES: KnowledgeSource[] = [
  ...
  { repository: 'Aftergraph/wi-backend', ref: 'main', commitSha: 'f2c7843b30d3cffaa8756399463edfed90a01fc0', owner: 'Work Intelligence', kind: 'api', visibility: 'public', maturity: 'OpenAPI 3.1.0 / API v0.2.0' },

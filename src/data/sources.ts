...
export const SOURCES: KnowledgeSource[] = [
  { repository: 'Aftergraph/after-graph-governance', ref: 'main', commitSha: 'd5972d1240cc2d0347f3a2ea6c0493bcd2f6577c', owner: 'Governance', kind: 'contract', visibility: 'public' },
  ...
  { repository: 'Aftergraph/work-intelligence-v2', ref: 'main', commitSha: 'e50b21c4694935ba19af7cdfa9fe5d38b1fe44a0', owner: 'Work Intelligence', kind: 'api', visibility: 'public', maturity: 'OpenAPI 3.1.0 / API v0.2.0' },
